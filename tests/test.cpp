...
TEMPLATE_TEST_CASE("Rational::Rational", "", std::int8_t, std::int16_t, std::int32_t, std::int64_t)
{
...
TEMPLATE_TEST_CASE("std::numeric_limits", "", std::int8_t, std::int16_t, std::int32_t, std::int64_t)
{
